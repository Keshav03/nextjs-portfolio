...
export default function Footer(props) {
    ...
    return (
        <div className=' relative h-auto p-5 bg-[#242526] w-screen mx-auto flex flex-col justify-center items-center'>
            ...
            <div className='flex justify-evenly self-center uppercase text-xs p-5 sm:hidden  md:hidden md:justify-between lg:flex w-1/3 text-white tracking-widest p-b-10 '>
			...
			<hr className='bg-white h-[1px] w-3/5'/>

			<p className='text-white text-xs p-4'>Copyright 2022 © Keshav Bokhoree </p>
