...
export default function About(props) {
    ...
    return (
        <div className='w-screen bg-[#000]/30'>

        <div className='relative h-auto p-5 w-screen flex flex-col mx-auto md:flex-row md:justify-between md:items-center md:max-w-7xl' id="about">
			...
			<div className=' flex justify-center items-center w-4/5 text-white text-sm mx-auto md:w-4/5 md:h-80 md:m-0 p-1'>   
